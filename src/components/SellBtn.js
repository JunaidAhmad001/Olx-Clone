...
const CustomButton = styled(Button)(({ theme }) => ({
  ...
  '& .text': {
    fontSize: '200px', // Increased font size
...
function SellBtn() {
  ...
  return (
    <CustomButton onClick={goToPostAdd}>
      <SvgIcon
        component="svg"
      ...
      >
        ...
        <path
          ...
          fill="#3a77ff"
        />
        <foreignObject x="0" y="0" width="1603" height="768">
          <Box 
            display="flex"
            alignItems="center"
            justifyContent="center"
            ...
            height="100%"
          >
            <img className="icon" src='https://www.olx.com.pk/assets/iconPlusSell_noinline.75fc7ea23e80b50447cf5757d8ef083a.svg' alt='Sell plus...' />
